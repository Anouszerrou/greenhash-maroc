...
const Home = () => {
  ...
  // Temporary welcome banner to ensure Home always shows clear content
  const WelcomeBanner = () => (
    <div className="bg-primary-900/80 text-white py-6 rounded-lg mb-8 max-w-4xl mx-auto text-center">
      <h2 className="text-2xl font-bold">Bienvenue sur Green Hash Maroc – Plateforme Web3 Écologique</h2>
      <p className="text-sm text-gray-200 mt-2">Minage durable, staking et échange de tokens pour un impact positif.</p>
    </div>
  );
