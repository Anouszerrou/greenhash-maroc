...
import { Users, MessageCircle, Mail, MapPin, Phone, Send, Twitter, Discord, Telegram, Github } from 'lucide-react';
...
const Community = () => {
  ...
  const socialLinks = [
    { icon: <Discord className="w-6 h-6" />, name: 'Discord', members: '15,000+', href: '#', color: 'bg-indigo-500' },
    { icon: <Telegram className="w-6 h-6" />, name: 'Telegram', members: '8,500+', href: '#', color: 'bg-blue-500' },
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">contact@greenhashmaroc.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">+212 5 22 123 456</p>
                  </div>
                </div>
              </div>
            </div>
